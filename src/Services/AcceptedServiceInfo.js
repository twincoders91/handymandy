...
const AcceptedServiceInfo = () => {
  ...
  return (
    <>
      ...
      <span className="fw700 fs32 mt24 mb24 white">Review Service</span>
      <div className="service--info--card">
        ...
        <div className="service--info--card--bottom">
          ...
          <div className="type--of--work">
            ...
            <button
              className="review--and--submit--button br4 fw700 fs12"
...
export default AcceptedServiceInfo;
